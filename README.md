...
```sh
$ go get -u github.com/amanbolat/zo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/amanbolat/zo
```
...
$ cp $GOPATH/src/github.com/amanbolat/zo/templates/* templates/
```
...
$ sudo cp $GOPATH/src/github.com/amanbolat/zo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/amanbolat/zo
```
